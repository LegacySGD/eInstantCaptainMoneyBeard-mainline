...
public class CaptainMoneyBeardWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(CaptainMoneyBeardWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/CaptainMoneyBeardIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/CaptainMoneyBeardIW/InitOutcome.xml").getDocumentElement();
